const posts = [
    ...
    },
    {
      ...
      description: "Sponsored",
      imageSize: 32,
      title: "Cuarto post de ejemplo",
      postDescription:
        "Mauris in est risus. Proin eget mi fermentum, viverra purus sed, fringilla turpis. Nulla facilisi.",
      hashtags: ["#Hashtag", "#Ideas", "#Liderazgo", "#Hashtag", "#Creatividad", "#Hashtag"]
    },
    {
      avatar: "https://newprofilepic.photo-cdn.net//assets/images/article/profile.jpg?90af0c8",
      name: "Pedro Torres",
      description: "Sponsored",
      imageSize: 32,
      title: "Quinto post de ejemplo",
      postDescription:
        "Suspendisse orci sapien, vehicula non bibendum in, maximus in sapien. In condimentum, mi vel consequat imperdiet.",
      hashtags: ["#Hashtag", "#Hashtag", "#Tendencias", "#Hashtag", "#Inspiración", "#Negocios"]
    }
  ];
